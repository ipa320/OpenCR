...
bool Turtlebot3MecanumCoreMotorDriver::readEncoder(int32_t &left_front_value, int32_t  &right_front_value, int32_t  &left_rear_value, int32_t  &right_rear_value) {
...
bool Turtlebot3MecanumCoreMotorDriver::writeVelocity(int64_t left_front_value, int64_t right_front_value, int64_t left_rear_value, int64_t right_rear_value)
{
...
bool Turtlebot3MecanumCoreMotorDriver::controlMotor(const float r, const float wheel_separation_x, const float wheel_separation_y, float* value)
{
  ...
  wheel_velocity_rad_per_s[LEFT_FRONT]  = (1/r) * (lin_x_vel - lin_y_vel - (wheel_separation_x + wheel_separation_y) * ang_vel);
  wheel_velocity_rad_per_s[RIGHT_FRONT] = (-1) * (1/r) * (lin_x_vel + lin_y_vel + (wheel_separation_x + wheel_separation_y) * ang_vel);
  wheel_velocity_rad_per_s[LEFT_REAR]   = (1/r) * (lin_x_vel + lin_y_vel - (wheel_separation_x + wheel_separation_y) * ang_vel);
  wheel_velocity_rad_per_s[RIGHT_REAR]  = (-1) * (1/r) * (lin_x_vel - lin_y_vel + (wheel_separation_x + wheel_separation_y) * ang_vel);
